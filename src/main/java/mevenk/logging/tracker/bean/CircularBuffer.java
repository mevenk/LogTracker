package mevenk.logging.tracker.bean;
...
/**
 * <p>
 * Implementation of a circular buffer with a specified capacity. Type T
 * represents the object's type which this buffer will operate with.
 * </p>
 *
 * <p>
 * If a buffer is full while adding a new element then the following algorithm
 * takes place:
 * <ul>
...
public class CircularBuffer<T> implements Iterable<T> {
	...
	@Subscribe
	private void eventReceived(T item) {
		add(item);
	}
